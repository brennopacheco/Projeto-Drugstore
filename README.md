...
```
cd existing_repo
git remote add origin https://gitlab.com/RaniereMendes/drugstore.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/RaniereMendes/drugstore/-/settings/integrations)
